...
1. in SSH you can manually pull the data to a file `curl http://172.27.153.1/cgi-bin/dl_cgi?Command=DeviceList -o "$HOME/PVS6outputJSON/$(date +%Y%m%d_%H%M%S).json"`
...
Note May be an additional URL query string at http://172.27.153.1/vars?match=/

Not useful yet! details at [Reddit post](https://www.reddit.com/r/SunPower/comments/1nn6qsf/pvs_firmware_update_20259_fast_local_monitoring/)

<pre>
{
  "values": [
    {
      "name": "/sys/info/serialnum",
      "value": "ZT12345678"
    },
    {
      "name": "/sys/info/model",
    ...
    {
      "name": "/sys/info/fwrev",
      "value": " Major 2, Revision 0x6131c9f8, Build 1188"
    },
    {
      "name": "/sys/info/boardtype",
      "value": "A0K LIB 1.0 PSoC5"
    },
    {
      "name": "/sys/info/sw_rev",
      "value": "2025.06.11.61839"
    },
    {
      "name": "/sys/info/ssid",
      "value": "SunPower46032"
    ...
    {
      "name": "/sys/info/active_interface",
      "value": "sta0"
    },
    {
      "name": "/hw/led/default_color",
      "value": "FOREST"
    },
    {
      "name": "/hw/led/default_color_rgb",
      "value": "000000"
    },
    {
      "name": "/hw/led/color",
    ...
    {
      "name": "/hw/led/sequence",
      "value": ""
    },
    {
      "name": "/network/report/send",
      "value": "0"
    }
  ],
  "count": 15
